		...
		<div class="w-full max-w-md" in:fly={{ y: 20, duration: 600, delay: 200 }}>
			<div class="bg-white p-8 rounded-2xl shadow-xl border border-indigo-50 relative overflow-hidden">
				...
				<div class="relative">
					...
					<p class="text-gray-500 mb-6">Rejoignez-nous pour mieux organiser vos tâches</p>
					...
					<form method="POST" use:enhance class="space-y-5">
						<div class="grid grid-cols-2 gap-4">
							<div>
								...
								<input
									...
									required
									class="w-full px-3 py-3 border border-gray-300 rounded-xl text-gray-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all"
									placeholder="Jean"
								/>
							</div>
							<div>
						...
						<button
							type="submit"
							class="w-full bg-gradient-to-r from-indigo-600 to-purple-600 text-white py-3 px-4 rounded-xl hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition-all font-medium shadow-md hover:shadow-lg mt-2"
						>
							S'inscrire
						</button>
					</form>
					...
					<div class="mt-6 text-center">
						<p class="text-sm text-gray-600">
							...
							<a href="/login" class="font-medium text-indigo-600 hover:text-indigo-500 transition-colors">Connectez-vous</a>
						</p>
					</div>
